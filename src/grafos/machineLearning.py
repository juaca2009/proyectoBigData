...
if __name__ == "__main__":
    ...
    #carga de datos
    df = spark.read.csv("/tmp/data/dataCleanNew/*.csv", sep=',', header= True, inferSchema=True)
    ...
    vector = VectorAssembler(inputCols = ['Domestic', 'Beat', 'District', 'Community Area', 'X Coordinate', 'Y Coordinate', 
                                          ...
                                          'mesDel', 'diaDel', 'horaDel', 'minutoDel', 'Estacion', 'cant Colegios'], outputCol = 'atributos')
